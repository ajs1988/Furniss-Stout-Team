...
public class GameControl {
    ...
    private static void assignScenesToLocations(Map map, Scene[] scenes) {
        ...
        //start point
        locations[0][1].setScene(scenes[SceneType.prisoncell1.ordinal()]);
        locations[0][2].setScene(scenes[SceneType.prisoncell2.ordinal()]);
        locations[0][3].setScene(scenes[SceneType.amityfarm.ordinal()]);
        locations[0][4].setScene(scenes[SceneType.abnegationcommunity.ordinal()]);
        locations[0][5].setScene(scenes[SceneType.dauntlessfacility.ordinal()]);
        locations[1][0].setScene(scenes[SceneType.eruditehq.ordinal()]);
    }
}
